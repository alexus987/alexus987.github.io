...
$subject = " Заполненая форма с WTCQD2015"; // subject of the email that is sent
...
if( mail($to_email, $subject, $email_body, $headers) ) {	
	echo '<i class="glyphicon glyphicon-ok"></i> Благодарим Вас, ' .$nam. ' за письмо!';
} else {	
	echo '<i class="glyphicon glyphicon-remove"></i> Простите, ' .$nam. ', что-то пошло не так. Пожалуйста повторите попытку.';
}
die();